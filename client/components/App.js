...
render() {
    ...
    for (i=0; i<document.getElementsByClassName('nav')[0].children.length; i++) {
  console.log(document.getElementsByClassName('nav')[0].children[i])
  document.getElementsByClassName('nav')[0].children[i].style.display = "block";
  document.getElementsByClassName('nav')[0].children[i].style.float = "left";
  document.getElementsByClassName('nav')[0].children[i].style.padding = "32px";
}
  }
